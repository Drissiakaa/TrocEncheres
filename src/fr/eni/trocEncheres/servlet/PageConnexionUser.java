...
/**
 * Servlet implementation class PageConnexionUser
 * Servlet traitant la requête HTTP d'affichage du formulaire de connexion; elle
 * traite la reception des saisies utilisateur et valide ou non l'accès au site.
 */
